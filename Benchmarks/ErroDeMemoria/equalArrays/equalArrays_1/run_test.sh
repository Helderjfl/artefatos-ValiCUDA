...
if [[ $1 = "-run" || $2 = "-run" || $3 = "-run" || $4 = "-run" ]]; then
    ...
    vali_exec -cuda 0 run 2 ${programa}.o 8192 input1.txt
    vali_exec -cuda 1 run 2 ${programa}.o 8192 input2.txt
    # vali_exec -cuda 2 run 2 ${programa}.o 1 input3.txt
    # vali_exec -cuda 1 run 2 ${programa}.o 1
...
if [[ $1 = "-eval" || $2 = "-eval" || $3 = "-eval" || $4 = "-eval" ]]; then
    ...
    do 
        ...
        vali_eval "${criterios[$j]}" 2 "Host(0)" "Grid(1)" -cuda 8192
        echo " "
    done
fi
