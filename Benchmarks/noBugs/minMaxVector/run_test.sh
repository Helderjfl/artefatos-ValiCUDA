...
criterios=( "todos-nos" "todos-nos-grid" "todos-nos-host" "todos-nos-sinc" "todos-nos-sinc-grid" "todos-nos-sinc-host"
...
if [[ $1 = "-run" || $2 = "-run" || $3 = "-run" || $4 = "-run" ]]; then
    ...
    vali_exec -cuda 1 run 2 ${programa}.o "1" input3.txt
