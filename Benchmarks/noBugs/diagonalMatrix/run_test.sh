...
if [[ $1 = "-run" || $2 = "-run" || $3 = "-run" || $4 = "-run" ]]; then
    ...
    vali_exec -cuda 0 run 2 ${programa}.o "64 0" input2.txt
    vali_exec -cuda 1 run 2 ${programa}.o "64 1" input2.txt
    vali_exec -cuda 2 run 2 ${programa}.o "64 2" input2.txt
    vali_exec -cuda 3 run 2 ${programa}.o "64 3" input2.txt
