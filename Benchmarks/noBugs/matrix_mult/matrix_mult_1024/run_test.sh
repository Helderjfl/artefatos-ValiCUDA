...
if [[ $1 = "-run" || $2 = "-run" || $3 = "-run" || $4 = "-run" ]]; then
    ...
    vali_exec -cuda 0 run 2 ${programa}.o 32 input32.txt
    vali_exec -cuda 1 run 2 ${programa}.o 32 input64.txt
    ...
    # vali_exec -cuda 7 run 2 ${programa}.o 19 input7.txt
    ...
    # for i in {33..64};
    # do
    #     vali_exec -cuda $(($i-33)) run 2 ${programa}.o $(($i-32)) < "input$i.txt"
    # done
fi
...
# vali_exec -cuda 3 run 2 ${programa}.o 32 < input3.txt
# vali_exec -cuda 0 run 2 matrix_mult.o 1 < input0.txt
