...
# vali_exec -cuda 1 run 2 ${programa}.o 2 < input2.txt
# vali_exec -cuda 2 run 2 ${programa}.o 3 < input3.txt
# vali_exec -cuda 3 run 2 ${programa}.o 4 < input4.txt
# vali_exec -cuda 4 run 2 ${programa}.o 16 < input16.txt
# vali_exec -cuda 5 run 2 ${programa}.o 32 < input32.txt
# vali_exec -cuda 6 run 2 ${programa}.o 64 < input64.txt
