...
if [[ $1 = "-elem" || $2 = "-elem" || $3 = "-elem" || $4 = "-elem" ]]; then
    vali_elem 3 "Host(0)" "Grid0(1)" "Grid1(2)" -cuda
fi
...
if [[ $1 = "-run" || $2 = "-run" || $3 = "-run" || $4 = "-run" ]]; then
    ...
    vali_exec -cuda 1 run 2 ${programa}.o 1024 input2.txt
    vali_exec -cuda 2 run 2 ${programa}.o 1024 input3.txt
...
if [[ $1 = "-eval" || $2 = "-eval" || $3 = "-eval" || $4 = "-eval" ]]; then
    ...
    do 
        ...
        vali_eval "${criterios[$j]}" 3 "Host(0)" "Grid(1)" "Grid(2)" -cuda 1024 1024
        echo " "
    done
fi
